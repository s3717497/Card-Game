...
class BallPanel extends JPanel
{
   ...
   private static final int Y_INC = 5;
   // ball x,y and deltas
...
//      super.paintComponent(g);
      ...
      dx = (x < 0) ? X_INC : (x > getWidth()  - BALL_DIAMETER) ? -X_INC : dx;	x += dx;
      dy = (y < 0) ? Y_INC : (y > getHeight() - BALL_DIAMETER) ? -Y_INC : dy;	y += dy;
